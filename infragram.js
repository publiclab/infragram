...
var Image, b_exp, colorify, colormap, colormap1, download, file_reader, g_exp, get_channels, greyscale_colormap, histogram, hsv2rgb, image, infragrammar, m_exp, mode, ndvi, on_file_sel, r_exp, render, save_expressions, save_expressions_hsv, segmented_colormap, set_mode, update, update_colorbar,
  _this = this;
...
save_expressions_hsv = function(h, s, v) {
  ...
  return eval("b_exp = function(R,G,B){return hsv2rgb(" + h + "," + s + "," + v + ")[2];}");
};
