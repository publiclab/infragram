...
var Image, colorify, file_reader, get_channels, histogram, image, ndvi, on_file_sel, render, update;
...
update = function(img,mode) {
  var b, colormap, d, g, max, min, mode, ndvi_img, r, result, _ref, _ref1, _ref2, _ref3, _ref4;
  if (mode === "ndvi") {
