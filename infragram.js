...
var JsImage, b_exp, camera, colorify, colormap, colormap1, createBuffer, createContext, createTexture, drawScene, g_exp, generateShader, getURLParameter, get_channels, glHandleOnChangeFile, glHandleOnClickColor, glHandleOnClickDownload, glHandleOnClickGrey, glHandleOnClickNdvi, glHandleOnClickNir, glHandleOnClickRaw, glHandleOnLoadTexture, glHandleOnSlide, glHandleOnSubmitInfra, glHandleOnSubmitInfraHsv, glHandleOnSubmitInfraMono, glInitInfragram, glRestoreContext, glSetMode, glUpdateImage, greyscale_colormap, histogram, hsv2rgb, image, imgContext, infragrammar, jsHandleOnChangeFile, jsHandleOnClickColor, jsHandleOnClickDownload, jsHandleOnClickGrey, jsHandleOnClickNdvi, jsHandleOnClickNir, jsHandleOnClickRaw, jsHandleOnSlide, jsHandleOnSubmitInfra, jsHandleOnSubmitInfraHsv, jsHandleOnSubmitInfraMono, jsUpdateImage, m_exp, mapContext, mode, modeToEquationMap, ndvi, r_exp, render, rgb2hsv, save_expressions, save_expressions_hsv, segmented_colormap, setParametersFromURL, set_mode, update, updateImage, update_colorbar, vertices, webGlSupported,
  _this = this;
