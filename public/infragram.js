...
glRunInfragrammar = function(mode, colorized) {
  return glSetMode(imgContext, mode, colorized);
};
...
run_infragrammar = function(mode) {
  save_log();
  if (webGlSupported) {
    return glRunInfragrammar(mode.substr(13, 4), colorized);
  } else {
    colorized = false;
