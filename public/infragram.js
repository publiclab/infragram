...
var FileUpload, JsImage, b_exp, camera, colorify, colorized, colormap, colormap1, colormap2, createBuffer, createContext, createTexture, downloadImage, drawScene, g_exp, generateShader, getCurrentImage, getURLParameter, get_channels, glGetCurrentImage, glHandleOnClickColor, glHandleOnClickGrey, glHandleOnClickNdvi, glHandleOnClickRaw, glHandleOnSlide, glHandleOnSubmitInfra, glHandleOnSubmitInfraHsv, glHandleOnSubmitInfraMono, glInitInfragram, glRestoreContext, glSetMode, glShaderLoaded, glUpdateImage, greyscale_colormap, handleOnSubmit, histogram, hsv2rgb, image, imgContext, infragrammar, infragrammar_mono, jsGetCurrentImage, jsHandleOnClickGrey, jsHandleOnClickNdvi, jsHandleOnClickRaw, jsHandleOnSlide, jsHandleOnSubmit, jsHandleOnSubmitInfra, jsHandleOnSubmitInfraHsv, jsHandleOnSubmitInfraMono, jsUpdateImage, log, m_exp, mapContext, mode, modeToEquationMap, ndvi, preset_ndvi_blue, preset_ndvi_blue_color, preset_ndvi_red, preset_ndvi_red_color, preset_raw, r_exp, render, rgb2hsv, run_colorize, save_expressions, save_expressions_hsv, segmented_colormap, setParametersFromURL, set_mode, update, updateImage, update_colorbar, vertices, video_live, waitForShadersToLoad, webGlSupported,
  _this = this;
...
jsHandleOnSubmit = function() {
  ...
  return set_mode($('#modeSwitcher').val());
};
