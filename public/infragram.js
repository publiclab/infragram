...
sendImage = function(file) {
  ...
  upload.onload = function(event) {
    ...
    return $("#file-sel").prop("disabled", false);
  };
  return upload.readAsBinaryString(file);
};
